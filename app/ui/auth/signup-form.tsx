...
import { faAt, faKey, faExclamationCircle, faUserCircle, faArrowRight } from "@fortawesome/pro-solid-svg-icons";
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
              />
              <FontAwesomeIcon icon={faUserCircle} className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500 peer-focus:text-gray-900" />
            </div>
          </div>
          <div className="mt-4">
            <label
...
function SignUpButton() {
  ...
  return (
    <Button className="mt-4 w-full" aria-disabled={pending}>
      Create account <FontAwesomeIcon icon={faArrowRight} className="ml-auto h-5 w-5 text-gray-50" />
    </Button>
  );
}
